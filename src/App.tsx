  ...
  return (
    <div className="app-container">
      ...
      <footer className="site-footer" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', alignItems: 'center', textAlign: 'center', padding: '3rem 1.5rem 5rem' }}>
        <div className="footer-inner" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>
          <div className="footer-brand" style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
            <img src="/favicon.svg" alt="Logo" className="footer-logo" width="32" height="32" />
            <span style={{ fontSize: '1.1rem', fontWeight: 800, color: '#fff' }}>Kone Technologies</span>
          </div>

          <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', justifyContent: 'center', margin: '0.25rem 0' }}>
            <a 
